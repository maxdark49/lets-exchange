<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DirInfo.aspx.cs" Inherits="Planning.Admin.DirInfo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="body" class="width" style="direction:rtl"">

        <h3> الإتجاهات</h3>
        <h3 style="direction:rtl"><a href="AddDir.aspx">إضافة إتجاه</a></h3>
