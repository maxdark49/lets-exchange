<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SecInfo.aspx.cs" Inherits="Planning.Admin.SecInfo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div id="body" class="width" style="direction:rtl"">

        <h3> السكتورز</h3>
        <h3 style="direction:rtl"><a href="AddSector.aspx">إضافة سكتور</a></h3>
        ...
        <form id="form1" runat="server">
            ...
            ">
                <tr style="text-align:center">
                    ...
                    <th style="font-size:20px">الإسم</th>
