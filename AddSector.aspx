<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddSector.aspx.cs" Inherits="Planning.Admin.AddSector" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="body" class="width">
        <fieldset>
            <legend style="margin:0 auto;font-size: 24px;">إضافة بيانات السكتور</legend>
            <form id="form1" runat="server">

                <p>
                    <label for="name" style="float: right; text-align: right;">:إسم السكتور</label>
