...
{
    public partial class SecInfo : System.Web.UI.Page
    {
        ...
        private void getfields()
        {
            ...
            var test = from o in entities.SECTORS
                       select new
                       {
                           o.id,
                           o.SR_name,
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var deleteField = entities.SECTORS.Where(u => u.id == fieldID).First();
                ...
                entities.SECTORS.Remove(deleteField);
